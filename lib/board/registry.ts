...
const BOARDS: readonly Board[] = [
  ...
  },
  {
    ...
    studentCautions: [
      'The board publishes its Intermediate result as a roll-number search rather than a downloadable gazette — its Downloads page carries forms and tenders only, so there is no Part-II gazette file to open. Re-checked 2026-09-22, replacing a 2026-09-14 note that recorded only that automated checks had been refused.',
    ],
    lastVerifiedAt: VERIFIED_AT,
  },
  {
  ...
  },
  {
    ...
    resultDatasets: [blockedPartTwo()],
    studentCautions: [
      'Re-checked 2026-09-22: the board’s own homepage carries an Urdu notice linking its Intermediate Annual 2026 result, and that result page answers. The 2026-09-14 note recording a total refusal of automated checks no longer describes this board.',
    ],
    lastVerifiedAt: VERIFIED_AT,
  },
  {
