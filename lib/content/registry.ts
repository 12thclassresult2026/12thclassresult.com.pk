...
const BUILT_PAGES: PageEntry[] = [
  {
    ...
    internalLinksOut: [
      '/results/12th-class',
      '/results/punjab/12th-class',
      '/results/kpk/12th-class',
      '/results/sindh/12th-class',
      '/boards',
      '/gazette',
      '/about',
      '/methodology',
  ...
  {
    id: 'punjab-12th-class',
    path: '/results/punjab/12th-class',
    pageType: 'result-hub',
    intentId: 'region.punjab',
    sitemapSegment: 'results',
    status: 'published',
    index: true,
    title: 'Punjab 12th Class Result 2026 — All 9 BISE Boards',
    h1: 'Punjab 12th class result, board by board',
    description:
      'HSSC Part-II result status for all nine Punjab boards on one page: the committee date, each board official portal, and what each board site actually shows.',
    seoTarget: {
      primaryKeyword: 'punjab 12th class result',
      secondaryKeywords: ['punjab board result 2026', 'punjab hssc part 2 result'],
      semanticEntities: ['Punjab boards', 'PBCC', 'HSSC Part-II'],
      searchIntent: 'Transactional — find the right Punjab board and its official portal.',
      queryVariants: ['punjab 2nd year result', 'all punjab boards result'],
    },
    breadcrumb: [
      { name: 'Home', path: '/' },
      { name: '12th Class Result', path: '/results/12th-class' },
      { name: 'Punjab', path: '/results/punjab/12th-class' },
    ],
    sourceRequirementMode: 'derived',
    sourceIds: [],
    freshnessClass: 'A',
    ...
    lastVerifiedAt: UPDATED_AT,
    lastReviewedAt: UPDATED_AT,
    internalLinksOut: ['/results/12th-class', '/boards', '/gazette'],
  },
  {
    id: 'sindh-12th-class',
    path: '/results/sindh/12th-class',
    pageType: 'result-hub',
    intentId: 'region.sindh',
    sitemapSegment: 'results',
    status: 'published',
    index: true,
    title: 'Sindh 12th Class Result 2026 — Board by Board',
    h1: 'Sindh 12th class result, board by board',
    description:
      'HSC-II result status for every Sindh board. Hyderabad declares group by group; Karachi has not announced 2026 yet. See your board and open its official page.',
    seoTarget: {
      primaryKeyword: 'sindh 12th class result',
      secondaryKeywords: ['sindh board result 2026', 'hsc part 2 result sindh'],
      semanticEntities: ['Sindh boards', 'BIEK Karachi', 'BISE Hyderabad', 'HSC-II'],
      searchIntent:
        'Transactional — find the right Sindh board and whether its group has been declared.',
      queryVariants: ['sindh inter result', 'karachi 12th class result'],
    },
    breadcrumb: [
      { name: 'Home', path: '/' },
      { name: '12th Class Result', path: '/results/12th-class' },
      { name: 'Sindh', path: '/results/sindh/12th-class' },
    ],
    sourceRequirementMode: 'derived',
    sourceIds: [],
    freshnessClass: 'A',
  ...
  {
    id: 'kpk-12th-class',
    path: '/results/kpk/12th-class',
    pageType: 'result-hub',
    intentId: 'region.kpk',
    sitemapSegment: 'results',
    status: 'published',
    index: true,
    title: 'KPK 12th Class Result 2026 — All 8 BISE Boards',
    h1: 'KPK 12th class result, board by board',
    description:
      'HSSC Annual-I result status for all eight Khyber Pakhtunkhwa boards. Each board announces on its own date — see which have declared and open the right portal.',
    seoTarget: {
      primaryKeyword: 'kpk 12th class result',
      secondaryKeywords: ['kpk board result 2026', 'khyber pakhtunkhwa hssc result'],
      semanticEntities: ['KPK boards', 'BISE Peshawar', 'HSSC Annual-I'],
      searchIntent: 'Transactional — find the right KPK board and its official portal.',
      queryVariants: ['kpk 2nd year result', 'all kpk boards result'],
    },
    breadcrumb: [
      { name: 'Home', path: '/' },
      { name: '12th Class Result', path: '/results/12th-class' },
      { name: 'KPK', path: '/results/kpk/12th-class' },
    ],
    sourceRequirementMode: 'derived',
    sourceIds: [],
    freshnessClass: 'A',
