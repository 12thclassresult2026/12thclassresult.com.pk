...
async function main() {
  ...
  for (let pageNum = 1; pageNum <= doc.numPages; pageNum++) {
    ...
    if (pageNum % 100 === 0 || pageNum === doc.numPages) {
      ...
      console.log(`[Multan] Processed page ${pageNum}/${doc.numPages} (${totalCandidates} candidates, ${elapsed}s)`);
    }
  }
  ...
  console.log(`[Multan] FINISHED! Total: ${totalCandidates} candidates across ${fileIndex} SQL files in ${totalTime}s.`);
